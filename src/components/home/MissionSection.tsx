...
// Blur placeholder for mission image
const MISSION_BLUR_PLACEHOLDER = "data:image/jpeg;base64,";
          ...
          <div className="relative">
            <div className="relative h-96 lg:h-[600px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                quality={85}
                placeholder="blur"
                blurDataURL={MISSION_BLUR_PLACEHOLDER}
              />
